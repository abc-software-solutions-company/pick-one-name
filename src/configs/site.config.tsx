...
const schemaJsonLdOrganizationDefault = {
  ...
  '@type': 'Organization',
  founder: 'Khanh Mai',
  logo: 'https://stage.abcsoftwarecompany.com/og-abc.png',
  address: {
    '@type': 'PostalAddress',
...
const schemaJsonLdWebSiteDefault = {
  ...
  potentialAction: {
    '@type': 'SearchAction',
    target:
      'https://stage.abcsoftwarecompany.com/pages/search_results?q={search_term}',
    'query-input': 'required name=search_term'
  }
};
export const siteSettings = {
  name: 'ABC Software Solutions Company',
  ...
  defaultLanguage: 'en',
  facebookUrl: 'https://bit.ly/3bwkOgQ',
  twitterUrl: '#',
  linkedInUrl: 'https://bit.ly/3OnVGrr',
  contact: {
  ...
  schemaJsonLd: {
    ...
    showcases: [
      merge(schemaJsonLdOrganizationDefault, {
        ...
        description:
          'ABC showcases, where we show you about all the project we had worked on.'
      }),
      merge(schemaJsonLdWebSiteDefault, {})
    ],
    contact: [
      merge(schemaJsonLdOrganizationDefault, {
        ...
        description:
          'Get in touch with us, contact us via email and we will response promptly',
        email: 'hello@abcsoftwarecompany.com',
