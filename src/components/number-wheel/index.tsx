...
const NumberWheel: FC<INumberWheelProps> = ({className}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full w-full select-none gap-3">
        <div className="flex w-full items-center justify-center rounded-sm text-center">
          <div className="relative flex h-[65px] w-full items-center gap-3 overflow-hidden rounded-xl lg:h-lg-number-container 3xl:h-2xl-number-container">
            <div className="wheel-container flex h-full w-full items-center justify-center gap-10 md:scale-150 lg:gap-18 3xl:scale-150 3xl:gap-20">
      ...
      <Button
        className="inline-flex h-14 w-2/3 items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-1 text-sm
        font-semibold text-neutral-50 hover:bg-blue-700 md:w-full md:py-4 md:px-8 md:text-lg lg:w-[40%]"
