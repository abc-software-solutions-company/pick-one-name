  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-center rounded-sm text-center">
        <div
          className="relative flex h-16 xs:h-14 w-full items-center gap-3 overflow-hidden 
        rounded-xl md:h-24 lg:h-lg-number-container 3xl:h-2xl-number-container"
        >
          <div
            className="wheel-container flex h-full w-full items-center justify-center 
            gap-11 xs:scale-100 xs:gap-10 md:scale-175 lg:scale-150 lg:gap-14 3xl:gap-20"
