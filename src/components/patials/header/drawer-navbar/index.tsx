...
export default function DrawerNavbar(props: Props) {
  ...
  const drawer = (
    <section>
      <div className="border-b border-gray-300 px-5 py-2 md:max-h-21 md:py-4">
        <button
  ...
  return (
    <>
      ...
      <AppBar
        component="nav"
        className="relative top-0 w-full border-b border-gray-300 bg-neutral-50 px-5 py-2 text-dark-950 shadow-none md:max-h-21 md:px-5 md:py-4 lg:px-[50px] 3xl:px-[100px]"
      >
